          ...
          <template v-else-if="result">
            ...
            <ul class="space-y-2 text-sm">
              <li class="flex items-center gap-2">
                ...
                <span class="text-slate-700">{{ $t('admin.teams.checkConfig') }}</span>
              </li>
              <li class="flex items-center gap-2">
              ...
              <li class="flex items-center gap-2">
                ...
                <span class="text-slate-700">{{ $t('admin.teams.checkNotify') }}</span>
              </li>
              <li class="flex items-center gap-2">
                ...
                <span class="text-slate-700">{{ $t('admin.teams.checkAad') }}</span>
              </li>
              <li class="flex items-center gap-2">
                ...
                <span class="text-slate-700">{{ $t('admin.teams.checkChat') }}</span>
              </li>
              <li class="flex items-center gap-2">
                ...
                <span class="text-slate-700">{{ $t('admin.teams.checkSent') }}</span>
              </li>
            </ul>
          </template>
        </div>

...
export function createSeed(): DemoState {
  return {
    ...
    projects: [
      { id: 1, name: '모바일 쇼핑몰 앱', description: 'iOS/Android 하이브리드 쇼핑몰 앱 리뉴얼 프로젝트. 신규 결제 시스템 도입 및 UI/UX 개선.', status: 'active', pinnedBy: [], createdAt: '2026-01-15T00:00:00', updatedAt: '2026-01-15T00:00:00' },
      { id: 2, name: '관리자 대시보드', description: '내부 운영팀을 위한 실시간 데이터 분석 및 모니터링 대시보드 구축.', status: 'active', pinnedBy: [], createdAt: '2026-02-20T00:00:00', updatedAt: '2026-02-20T00:00:00' },
      { id: 3, name: 'SNS 연동 API', description: '카카오톡, 인스타그램, 네이버 등 외부 SNS 플랫폼 연동 API 개발.', status: 'paused', pinnedBy: [], createdAt: '2026-03-10T00:00:00', updatedAt: '2026-03-10T00:00:00' },
      { id: 4, name: '회원 시스템 v2', description: '기존 회원 인증 시스템 전면 개편. OAuth2 + MFA 다중 인증 도입.', status: 'completed', pinnedBy: [], createdAt: '2025-11-01T00:00:00', updatedAt: '2025-11-01T00:00:00' },
    ],
    ...
    qa: [
      { id: 1, updateId: 1, title: '카드 결제 시 오류 메시지 미표시', description: '유효하지 않은 카드 번호 입력 시, 오류 메시지가 노출되지 않고 로딩 인디케이터만 무한 회전.', category: '결제', status: 'confirmed', testerId: 4, assignee1Id: 1, assignee2Id: null, priority: 'high', images: ['https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&h=600&fit=crop', 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop'], createdAt: '2026-04-05T00:00:00', updatedAt: '2026-04-12T00:00:00' },
      { id: 2, updateId: 1, title: '간편결제(토스) 취소 후 재시도 불가', description: '토스페이 결제 취소 후 동일 세션에서 재결제 시 "세션 만료" 오류 발생.', category: '결제', status: 'in_progress', testerId: 4, assignee1Id: 2, assignee2Id: null, priority: 'critical', images: ['https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=800&h=600&fit=crop'], createdAt: '2026-04-06T00:00:00', updatedAt: '2026-04-18T00:00:00' },
      { id: 3, updateId: 1, title: '영수증 이메일 발송 지연', description: '결제 완료 후 영수증 이메일이 10분 이상 지연되어 발송됨. 평균 30초 내 발송 필요.', category: '결제', status: 'needs_fix', testerId: null, assignee1Id: 3, assignee2Id: null, priority: 'medium', images: [], createdAt: '2026-04-08T00:00:00', updatedAt: '2026-04-08T00:00:00' },
      { id: 4, updateId: 2, title: '푸시 클릭 시 앱 미실행', description: '백그라운드 상태에서 푸시 알림 클릭 시, 앱이 포그라운드로 전환되지 않음.', category: '알림', status: 'needs_fix', testerId: null, assignee1Id: 1, assignee2Id: null, priority: 'high', images: ['https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=800&h=600&fit=crop', 'https://images.unsplash.com/photo-1551650975-87deedd944c3?w=800&h=600&fit=crop', 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=800&h=600&fit=crop'], createdAt: '2026-04-22T00:00:00', updatedAt: '2026-04-22T00:00:00' },
      { id: 5, updateId: 2, title: '딥링크 파라미터 누락', description: '푸시 알림의 딥링크 URL에 campaign_id 파라미터가 누락되어 추적 불가.', category: '알림', status: 'fix_done', testerId: 4, assignee1Id: 2, assignee2Id: null, priority: 'low', images: [], createdAt: '2026-04-23T00:00:00', updatedAt: '2026-04-25T00:00:00' },
      { id: 6, updateId: 5, title: 'AI 위젯 예측값 0으로 표시', description: '트래픽 급증 상황에서 AI 이상탐지 위젯의 예측값이 0으로 고정 표시됨.', category: '홈 개편', status: 'in_progress', testerId: 4, assignee1Id: 4, assignee2Id: 2, priority: 'critical', images: ['https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&h=600&fit=crop'], createdAt: '2026-05-12T00:00:00', updatedAt: '2026-05-14T00:00:00' },
      { id: 7, updateId: 5, title: '위젯 새로고침 시 데이터 섞임', description: '수동 새로고침 후 위젯 간 데이터가 섞여 표시됨. 캐싱 문제로 추정.', category: '홈 개편', status: 'needs_recheck', testerId: null, assignee1Id: 5, assignee2Id: null, priority: 'medium', images: [], createdAt: '2026-05-13T00:00:00', updatedAt: '2026-05-13T00:00:00' },
      { id: 8, updateId: 6, title: '카카오 친구 목록 동기화 실패', description: '친구 목록 API 호출 시 500 에러 반환. SDK 버전 충돌 가능성.', category: '카카오 연동', status: 'on_hold', testerId: null, assignee1Id: 3, assignee2Id: null, priority: 'high', images: [], createdAt: '2026-03-22T00:00:00', updatedAt: '2026-03-22T00:00:00' },
      { id: 9, updateId: 7, title: 'MFA QR 코드 스캔 실패', description: '일부 Android 기기에서 QR 코드 스캔 후 인증 코드 생성 불가.', category: '인증', status: 'confirmed', testerId: 4, assignee1Id: 4, assignee2Id: null, priority: 'high', images: [], createdAt: '2025-12-05T00:00:00', updatedAt: '2025-12-10T00:00:00' },
    ],

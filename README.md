...
| 대시보드 (사이드바 + 요약 카드)         | QA 상세 (3분할 뷰 · 사이드바 자동 접힘)  |
|--------------------------------------|---------------------------------------|
| ![대시보드](docs/images/dashboard.jpg) | ![QA 상세](docs/images/qa-detail.jpg) |

| 프로젝트 상세 (사이드바 트리 · 업데이트별 QA) | 설정 (Discord 식 전체 화면)              |
|-----------------------------------------------|------------------------------------------|
| ![프로젝트 상세](docs/images/project-detail.jpg) | ![설정](docs/images/settings.jpg)      |
...
| 알림 페이지 (목록 │ QA 내용)                     | 이메일 OTP 2단계 로그인                  |
|--------------------------------------------------|------------------------------------------|
| ![알림 페이지](docs/images/notifications.jpg)    | ![OTP 로그인](docs/images/login-otp.jpg) |
